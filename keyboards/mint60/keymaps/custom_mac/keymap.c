...
/*
  BUILD: % make mint60:custom_mac
  WRITE: % make mint60:custom_mac:avrdude
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_ESC,    KC_LALT,    GUI_T(KC_LANG2),  KC_LANG2,    KC_SPC,       KC_ENT,   KC_LANG1, KC_BSPC,        KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
